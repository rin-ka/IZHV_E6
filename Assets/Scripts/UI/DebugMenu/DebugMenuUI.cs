        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    GUILayout.Label(currency.ToString(), GUILayout.Width(WINDOW_DIMENSION.x / 4.0f));
                }
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    if (interactiveMode != GameManager.Instance.interactiveMode)
                    {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    GUILayout.Label(masterVolume.ToString("F1") + " dB", GUILayout.Width(WINDOW_DIMENSION.x / 4.0f));
                }
                GUILayout.EndHorizontal();
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    isMuted = GUILayout.Toggle(isMuted, "Muted");
